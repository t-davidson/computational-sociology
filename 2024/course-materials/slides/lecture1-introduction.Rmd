...
# Introduction to Computational Sociology
## Measuring diurnal rhythms using Twitter
```{r, out.width="70%",out.height="60%", fig.align="center"}
...
- Capacity to study texts and other non-tabular data also opens new opportunities to conduct qualitative analysis at scale
    - Topic modeling as content analysis (e.g., DiMaggio, Nag, and Blei 2013; Mohr et al. 2013)
    - Computational ethnography (Abramson et al. 2018)
    - Conversational content analysis (Davidson 2024?)
- Hybrid, mixed-methods approaches combining computational methods with qualitative analysis

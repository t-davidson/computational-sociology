...
- Download and inspect this code in RStudio (paste it into a new R file)
    - \url{https://raw.githubusercontent.com/t-davidson/computational-sociology/main/2024/course-materials/code/l1_problem_1.R}
...
```{r, echo=TRUE, tidy=TRUE, mysize=TRUE, size='\\footnotesize', warning=F}
setwd("..")
getwd()
```
...
```{r, echo=TRUE, tidy=TRUE, mysize=TRUE, size='\\footnotesize', message=F}
library("tidyverse")
...
# Excercise
Uncomment the code and omplete the path to print the contents of the file hiding in the `2021` directory.

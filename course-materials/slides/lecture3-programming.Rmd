...
- If-else statements allow us to chain together one or more conditional actions.
  - e.g. If time is between 4:10-6:50pm, attend computatinal sociology class meeting. Else, do something else.
...
```
\footnotesize  Note how magrittr provides aliases for certain mathematic operations as shown in the second line. https://stackoverflow.com/questions/27364390/chain-arithmetic-operators-in-dplyr-with-pipe#_=_
...
# Pipes
In this case the expressins have been nested. This is better as we are not unnecessarily storing intermediate objects. 

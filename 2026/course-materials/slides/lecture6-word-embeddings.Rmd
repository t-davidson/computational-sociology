...
We will use 50-dimensional GloVe vectors trained on six billion tokens from Wikipedia and Gigaword. The model contains vectors for 400,000 terms and is 163 MB uncompressed.

\footnotesize Model source: \url{https://github.com/piskvorky/gensim-data}

Package documentation: \url{https://github.com/bnosac/word2vec}
```{r, echo=TRUE, tidy=FALSE, mysize=TRUE, size='\\scriptsize'}
